...
formElem.onsubmit = function(event) {
    ...
    // ANSWER
    // The input field with constantly refresh, not allowing for the pyramid to print nor error messages to stay.
    ...
    // ANSWER
    //If a user enters an invalid input and then a valid one, it will still show the error message.
